...
var CustomFilter = /** @class */ (function (_super) {
    ...
    CustomFilter.prototype.render = function () {
        ...
        return react_1.default.createElement("div", { className: 'lirl-custom-filter-container' },
            title,
            react_1.default.createElement(antd_1.Popover, __assign({}, popoverProps),
                react_1.default.createElement(antd_1.Icon, { onClick: this.filterOnClick, type: "filter", className: reg ? '' : 'anticon-filter-active' })));
    };
    return CustomFilter;
...
var FilterTableHeaderItem = /** @class */ (function (_super) {
    ...
    FilterTableHeaderItem.prototype.render = function () {
        ...
        return react_1.default.createElement("div", { className: 'lirl-custom-filter-filter' },
            react_1.default.createElement(FormItem, null, getFieldDecorator(name, {
                rules: [{
            ...
            react_1.default.createElement("div", { style: {
                ...
                react_1.default.createElement(antd_1.Button, { disabled: util_1.hasErrors(getFieldsError([name])), onClick: function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                react_1.default.createElement(antd_1.Button, { onClick: this.cannel }, " \u53D6\u6D88 ")));
    };
